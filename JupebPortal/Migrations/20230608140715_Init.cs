        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Programme1Id = table.Column<int>(type: "int", nullable: false),
                    Programme2Id = table.Column<int>(type: "int", nullable: true),
                    GuardName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GuardEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GuardPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationForms_Programmes_Programme1Id",
                        column: x => x.Programme1Id,
                        principalTable: "Programmes",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ApplicationForms_Programmes_Programme2Id",
                        column: x => x.Programme2Id,
                        principalTable: "Programmes",
                        principalColumn: "id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationForms_Programme1Id",
                table: "ApplicationForms",
                column: "Programme1Id");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationForms_Programme2Id",
                table: "ApplicationForms",
                column: "Programme2Id");
